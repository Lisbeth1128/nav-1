...
var render = function render() {
  ...
  hashMap.forEach(function (node, index) {
    var $li = $("<li><div class='logo'>".concat(node.logo[0], "</div>\n      <div class='link'>").concat(simplifyUrl(node.url), "</div>\n      <div class='close'><svg class=\"icon\"><use xlink:href=\"#icon-delete\"></use></svg></div></li>")).insertBefore($lastLi);
...
//# sourceMappingURL=main.5af32f49.js.map